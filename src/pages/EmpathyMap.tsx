    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: '-apple-system, "Segoe UI", sans-serif' }}>
      ...
      <header className="py-10 px-6 text-white text-center" style={{ backgroundColor: '#1B6B5A' }}>
        ...
        <p className="text-sm italic opacity-90 max-w-2xl mx-auto">
          Government Staff User — Synthesised from Sandra (Service Officer) and Marcus (Field Operations Coordinator)
        </p>
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-8 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <ul className="text-sm list-disc list-inside mb-4 space-y-0.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>Be recognised as competent and responsive</li>
            ...
            <ul className="text-sm list-disc list-inside space-y-0.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>No automatic resident acknowledgements</li>
          ...
          >
            ...
            <ul className="text-sm list-disc list-inside mb-4 space-y-0.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>Minimise rework and double-visits</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-lg p-6" style={{ backgroundColor: '#E8F4F0', border: '1px solid #ddd', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
            ...
            <ul className="text-sm list-disc list-inside space-y-1.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>"Automatic acknowledgements would cut my complaint calls in half."</li>
          ...
          <div className="rounded-lg p-6" style={{ backgroundColor: '#FDF0E8', border: '1px solid #ddd', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
            ...
            <ul className="text-sm list-disc list-inside space-y-1.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>Colour-codes spreadsheet rows to flag overdue items</li>
          ...
          <div className="rounded-lg p-6" style={{ backgroundColor: '#F3EEF8', border: '1px solid #ddd', boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
            ...
            <ul className="text-sm list-disc list-inside space-y-1.5" style={{ color: '#2D2D2D' }}>
              ...
              <li>Demoralised when communication failures make good work invisible</li>
              ...
              <li>Proud and energised when a complex job reaches resolution</li>
        ...
        <div className="rounded-lg p-6" style={{ backgroundColor: '#F5F5F5' }}>
          ...
          <ol className="text-sm list-decimal list-inside space-y-3" style={{ color: '#2D2D2D' }}>
            <li>
              <span className="font-semibold">Automatic acknowledgements</span> are the single highest-impact change staff identified. The moment a request is received, an automated confirmation with a reference number should be sent to the citizen — removing a major source of complaint calls.
            </li>
            <li>
            ...
            <li>
              <span className="font-semibold">Manual data entry</span> is a significant morale drain. The system should eliminate manual status updates, completion logging, and acknowledgement emails wherever possible.
            </li>
            <li>
      ...
      <footer className="text-center text-sm py-6 px-6" style={{ backgroundColor: '#F5F5F5', borderTop: '1px solid #DDDDDD', color: '#666666' }}>
        ...
        <p className="mt-2 max-w-2xl mx-auto" style={{ color: '#999999' }}>
          Synthesised from two simulated empathy interviews conducted in lieu of live user interviews. Content reflects realistic government staff workflows. To be referenced in Sprint 3 staff dashboard design decisions.
        </p>
      </footer>
    </div>
  );
